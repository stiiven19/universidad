# Harmony - Tu Espacio de Relajación

Aplicación de bienestar integral para Android desarrollada en Kotlin, diseñada para ayudarte a encontrar la paz interior y mejorar tu calidad de vida.
...
- `app/src/main/java/com/example/projecta/` - Código fuente de la aplicación
- `app/src/main/res/` - Recursos (layouts, drawables, strings, etc.)
- `app/build.gradle` - Configuración del módulo de la aplicación


## Contribución

Las contribuciones son bienvenidas. Por favor, comunicate con el equipo de desarrollo antes de enviar un pull request.
